...
class NotificationPlugin {
  ...
  Future<void> showNotificationWithAttachment(Order order) async {
    ...
    //    'http://52.44.163.255:8000/storage/app/public/25/Winden.jpeg', 'attachment_img.jpg');
     var attachmentPicturePath = await _getImageFromAsset('assets/img/logo.png', 'attachment_img.jpg');
    ...
    var bigPictureStyleInformation =  BigPictureStyleInformation(
      ...
      contentTitle: '<h1>Winix</h1> <b>Nuevo Pedido Asignado</b>',
      htmlFormatContentTitle: true,
      summaryText: order.orderStatus.status+': '+ order.deliveryAddress.address,
    ...
    await flutterLocalNotificationsPlugin.show(
      ...
      order.orderStatus.status + " - " + order.deliveryAddress.address,
      notificationDetails,
    );
  }
