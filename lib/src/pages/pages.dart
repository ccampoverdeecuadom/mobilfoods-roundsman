...
import 'package:roundsman/src/pages/availableOrders.dart';
...
class _PagesTestWidgetState extends State<PagesTestWidget> {
  ...
  void _selectTab(int tabItem) {
    setState(() {
      widget.currentTab = tabItem == 4 ? 0 : tabItem;
      switch (tabItem) {
        case 0:
          widget.currentPage = AvailableOrdersWidget(parentScaffoldKey: widget.scaffoldKey);
          break;
        case 1:
          ...
          items: [
            BottomNavigationBarItem(
                ...
                icon: Container(
                  ...
                  child: new Icon(Icons.settings_input_antenna_rounded, color: Theme.of(context).primaryColor),
                )),
            BottomNavigationBarItem(
