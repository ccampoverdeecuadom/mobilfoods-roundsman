...
Future<Stream<Order>> getAvailableOrders() async {
  Uri uri = Helper.getUri('api/driver/orders-available');
  Map<String, dynamic> _queryParams = {};
  User _user = userRepo.currentUser.value;
...
Future<bool> acceptOrder(id) async {
  final String _apiToken = 'api_token=${currentUser.value.apiToken}';
  final String url = '${GlobalConfiguration().getString('api_base_url')}driver/accept?$_apiToken';
  final client = new http.Client();
